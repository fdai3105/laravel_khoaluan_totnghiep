                ...
                <ul class="flex-1 text-base pt-2 space-y-3">
                    ...
                    <li>
                        <a href="{{ route('order.index') }}"
                           class="{{ request()->is('order') ? 'bg-gray-700' : 'bg-gray-900' }} hover:bg-gray-700 transition-colors duration-100 text-blue-200 flex items-end py-3 px-4 space-x-2 rounded-lg font-bold text-opacity-70 hover:text-opacity-100">
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
