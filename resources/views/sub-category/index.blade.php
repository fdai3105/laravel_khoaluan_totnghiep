...
@section('body')
    @include('sub-category.particles.add-modal')
        ...
        <div class="bg-gray-700 overflow-hidden overflow-y-scroll rounded-lg mt-8">
            <table class="min-w-full text-left">
                ...
                <tr>
                    ...
                    <th class="bg-gray-600 py-2 px-3 sticky top-0">Parent</th>
                ...
                @foreach($categories as $category)
                    <tr>
                        ...
                        <td class="py-3 px-3">
                            <!-- edit button -->
                            @include('sub-category.particles.edit-modal',['category'=>$category])
                            <button type="button"
                            ...
                            <!-- remove button -->
                            @include('sub-category.particles.remove-modal',['id'=> $category->id, 'name'=>$category->name])
                            <button type="button"
