...
fetch(url, {
    ...
    .then(json =&gt; console.log(json));</code></pre>
<h3>HTTP Request</h3>
<p><code>POST api/address</code></p>
...
<h3>HTTP Request</h3>
<p><code>GET api/address/{address}</code></p>
...
fetch(url, {
    ...
    .then(json =&gt; console.log(json));</code></pre>
<h3>HTTP Request</h3>
<p><code>PUT api/address/{address}</code></p>
<p><code>PATCH api/address/{address}</code></p>
...
fetch(url, {
    ...
    .then(json =&gt; console.log(json));</code></pre>
<h3>HTTP Request</h3>
<p><code>DELETE api/address/{address}</code></p>
...
fetch(url, {
    ...
    .then(json =&gt; console.log(json));</code></pre>
<h3>HTTP Request</h3>
<p><code>POST api/resend-email</code></p>
...
fetch(url, {
    ...
    .then(json =&gt; console.log(json));</code></pre>
<h3>HTTP Request</h3>
<p><code>PUT api/comment/{comment}</code></p>
<p><code>PATCH api/comment/{comment}</code></p>
...
fetch(url, {
    ...
    .then(json =&gt; console.log(json));</code></pre>
<h3>HTTP Request</h3>
<p><code>DELETE api/comment/{comment}</code></p>
...
<h2>Show sale product sort by discount</h2>
<blockquote>
<p>Example request:</p>
</blockquote>
<pre><code class="language-bash">curl -X GET \
...
<h3>HTTP Request</h3>
<p><code>GET api/sale-product</code></p>
<h4>Query Parameters</h4>
<table>
<thead>
<tr>
...
<h3>HTTP Request</h3>
<p><code>GET api/similar-product/{id}</code></p>
...
<h3>HTTP Request</h3>
<p><code>GET api/order/{id}</code></p>
