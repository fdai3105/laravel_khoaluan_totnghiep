...
@section('body')
    <div class="h-screen flex-1 flex flex-col bg-gray-800 py-4 lg:py-8 px-4 lg:px-6 xl:px-8 overflow-hidden">
        ...
        <div class="max-w-screen-2xl w-full mx-auto flex justify-between">
            <div>
                <h1 class="text-2xl mb-1 font-bold text-blue-100">User overview</h1>
                <p class="text-lg text-blue-200 hidden lg:block">{{ $users->count() }} items</p>
            </div>
            ...
            <div class="align-middle inline-block min-w-full overflow-hidden">
                <table class="min-w-full text-left">
                    ...
                    <tr>
                        ...
                        <th class="bg-gray-600 py-2 px-3 sticky top-0">Name</th>
                        <th class="bg-gray-600 py-2 px-3 sticky top-0">Email</th>
                        <th class="bg-gray-600 py-2 px-3 sticky top-0">Phone number</th>
                        <th class="bg-gray-600 py-2 px-3 sticky top-0">Gender</th>
